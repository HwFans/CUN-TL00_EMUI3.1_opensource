...
static imgsensor_info_struct imgsensor_info = { 
	...
	.pre = {
		...
		.linelength = 6080, //3800,				//record different mode's linelength
		.framelength = 1572, //2520,			//record different mode's framelength
		.startx =0,					//record different mode's startx of grabwindow
		.starty = 0,					//record different mode's starty of grabwindow
		.grabwindow_width = 1632, //3264,		//record different mode's width of grabwindow
		.grabwindow_height = 1224, //2448,		//record different mode's height of grabwindow
...
LOG_INF("E full size winsize modify preview\n"); 
...
write_cmos_sensor(0x0b22, 0xba80); //cc80); 
...
UINT32 HI843B_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
	...
	printk("HI843B_MIPI_RAW_SensorInit  >> baoyuanrui");
	if (pfFunc!=NULL)
		*pfFunc=&sensor_func;
	return ERROR_NONE;
